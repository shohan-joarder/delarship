...
<div class="content-header row">
    ...
    <div class="content-header-right text-md-end col-md-3 col-12 d-md-block d-none">
        <div class="mb-1 breadcrumb-right">
            <button type="button" class="btn btn-primary waves-effect waves-float waves-light waves-effect addNew" data-bs-toggle="modal" data-bs-target="#realWeedingModal"><i data-feather="plus" class="fw-bold"></i> Add New</button>
        </div>
    </div>
</div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-datatable">
                    <table class="dt-responsive table" id="realWeedingTable">
                        <thead>
                            <tr>
...
{{-- Modal start --}}
<div class="modal fade" id="realWeedingModal" tabindex="-1" aria-labelledby="exampleModalCenterTitle" style="display: none;" aria-hidden="true">
...
<script>
    $(document).ready(function () {
        ...
        var t = $('#realWeedingTable').DataTable(
                {
                    "scrollX":false,
                    "processing": true,
                    "serverSide": true,
        ...
        $("#realWeedingTable").on('draw.dt', function(){
            let n = 0;
        ...
        $(document).on("submit", "#realWeedingForm", function (e) {
            e.preventDefault();
            $(".errors").html("");
            formSubmit("realWeedingForm",$(this).attr("action"),"realWeedingModal",t)
        });

        $(document).on("click",".addNew",function(){
            $("#dataId").val('');
            $(".modaltitle").html("New real weeding");
        ...
        $(".modaltitle").html("Update real weeding");
