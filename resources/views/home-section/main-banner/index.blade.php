...
<div class="content-header row">
    ...
    <div class="content-header-right text-md-end col-md-3 col-12 d-md-block d-none">
        <div class="mb-1 breadcrumb-right">
            <button type="button" class="btn btn-primary waves-effect waves-float waves-light waves-effect addNew" data-bs-toggle="modal" data-bs-target="#mainBannerModal"><i data-feather="plus" class="fw-bold"></i> Add New</button>
        </div>
    </div>
</div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-datatable">
                    <table class="dt-responsive table" id="mainBanner">
                        <thead>
                            <tr>
...
{{-- Modal start --}}
<div class="modal fade" id="mainBannerModal" tabindex="-1" aria-labelledby="exampleModalCenterTitle" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form form-vertical" method="POST" action="{{route('main-banner.store')}}" id="mainBannerForm">
                    @csrf
...
<script>
    $(document).ready(function () {
        ...
        $("#mainBanner").on('draw.dt', function(){
            let n = 0;
        ...
        $(document).on("submit", "#mainBannerForm", function (e) {
            e.preventDefault();
            $(".errors").html("");
            formSubmit("mainBannerForm",$(this).attr("action"),"mainBannerModal",t)
        });

        $(document).on("click",".addNew",function(){
            $("#dataId").val('');
            $(".modaltitle").html("Create new banner");
        ...
        $.ajax({
            ...
            success : function(response){
                ...
                const{id,title,description,blog_category_id,sub_title,sort_order} = data;
                $("#dataId").val(id);
                $(".title").val(title);
