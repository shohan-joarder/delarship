...
<div class="content-header row">
    ...
    <div class="content-header-right text-md-end col-md-3 col-12 d-md-block d-none">
        <div class="mb-1 breadcrumb-right">
            <button type="button" class="btn btn-primary waves-effect waves-float waves-light waves-effect addNew" data-bs-toggle="modal" data-bs-target="#popularVanueModal"><i data-feather="plus" class="fw-bold"></i> Add New</button>
        </div>
    </div>
</div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-datatable">
                    <table class="dt-responsive table" id="popularVanueTable">
                        <thead>
                            <tr>
...
{{-- Modal start --}}
<div class="modal fade" id="popularVanueModal" tabindex="-1" aria-labelledby="exampleModalCenterTitle" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title modaltitle" id="">Create new banner</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form class="form form-vertical" method="POST" action="{{route('popular-vanues.store')}}" id="popularVanueForm">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="mb-1">
                                ...
                                <textarea class="form-control description" name="description" id="" cols="30" rows="5"></textarea>
                        ...
                        <div class="col-12">
                            <div class="mb-1">
                                <label class="form-label" for="first-name-vertical">Location</label>
                                <textarea class="form-control location" name="location" id="" cols="30" rows="5"></textarea>
                                <span class="text-danger text-xs errors error_location"></span>
                            </div>
                        </div>
...
<script>
    $(document).ready(function () {
        ...
        var t = $('#popularVanueTable').DataTable(
                {
                    "scrollX":false,
                    "processing": true,
                    "serverSide": true,
        ...
        $("#popularVanueTable").on('draw.dt', function(){
            let n = 0;
        ...
        $(document).on("submit", "#popularVanueForm", function (e) {
            e.preventDefault();
            $(".errors").html("");
            formSubmit("popularVanueForm",$(this).attr("action"),"popularVanueModal",t)
        });

        $(document).on("click",".addNew",function(){
            $("#dataId").val('');
            $(".modaltitle").html("Create new vanue");
        ...
        $.ajax({
            ...
            success : function(response){
                ...
                const{id,title,description,location,sort_order} = data;
                $("#dataId").val(id);
                $(".title").val(title);
