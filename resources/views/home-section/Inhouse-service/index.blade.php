...
<div class="content-header row">
    ...
    <div class="content-header-right text-md-end col-md-3 col-12 d-md-block d-none">
        <div class="mb-1 breadcrumb-right">
            <button type="button" class="btn btn-primary waves-effect waves-float waves-light waves-effect addNew" data-bs-toggle="modal" data-bs-target="#inhouseServiceModal"><i data-feather="plus" class="fw-bold"></i> Add New</button>
        </div>
    </div>
</div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-datatable">
                    <table class="dt-responsive table" id="inhouseServiceTable">
                        <thead>
                            <tr>
...
{{-- Modal start --}}
<div class="modal fade" id="inhouseServiceModal" tabindex="-1" aria-labelledby="exampleModalCenterTitle" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form form-vertical" method="POST" action="{{route('inhouse-service.store')}}" id="inhouseForm">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="mb-1">
                                ...
                                <span class="text-danger text-xs errors error_url"></span>
                            </div>
                        </div>

                        <div class="col-12">
                            <div class="mb-1">
                                <label class="form-label" for="first-name-vertical">Button Text</label>
                                <input type="text"  class="form-control button_text" name="button_text" placeholder="Button Text" >
                                <span class="text-danger text-xs errors error_button_text"></span>
                            </div>
                        </div>
...
<script>
    $(document).ready(function () {
        ...
        var t = $('#inhouseServiceTable').DataTable(
                {
                    "scrollX":false,
                    "processing": true,
                    "serverSide": true,
        ...
        $("#inhouseServiceTable").on('draw.dt', function(){
            let n = 0;
        ...
        $(document).on("submit", "#inhouseForm", function (e) {
            e.preventDefault();
            $(".errors").html("");
            formSubmit("inhouseForm",$(this).attr("action"),"inhouseServiceModal",t)
        });

        $(document).on("click",".addNew",function(){
            $("#dataId").val('');
            $(".modaltitle").html("New inhouse category");
        ...
        $(".modaltitle").html("Update inhouse category");
        ...
        $.ajax({
            ...
            success : function(response){
                ...
                const{id,title,sub_title,sort_order,url,button_text} = data;
                $("#dataId").val(id);
                $(".title").val(title);
                ...
                $("#thumbnail").val(photo);
                $("#inhouseServiceModal").modal("show");
            },
