...
<div class="content-header row">
    ...
    <div class="content-header-right text-md-end col-md-3 col-12 d-md-block d-none">
        <div class="mb-1 breadcrumb-right">
            <button type="button" class="btn btn-primary waves-effect waves-float waves-light waves-effect addNew" data-bs-toggle="modal" data-bs-target="#middleBannerModal"><i data-feather="plus" class="fw-bold"></i> Add New</button>
        </div>
    </div>
</div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-datatable">
                    <table class="dt-responsive table" id="middleBannerTable">
                        <thead>
                            <tr>
...
{{-- Modal start --}}
<div class="modal fade" id="middleBannerModal" tabindex="-1" aria-labelledby="exampleModalCenterTitle" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title modaltitle" id="">Create banner</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form class="form form-vertical" method="POST" action="{{route('middle-banner.store')}}" id="middleBannerForm">
                    @csrf
...
<script>
    $(document).ready(function () {
        ...
        var t = $('#middleBannerTable').DataTable(
                {
                    "scrollX":false,
                    "processing": true,
                    "serverSide": true,
        ...
        $("#middleBannerTable").on('draw.dt', function(){
            let n = 0;
        ...
        $(document).on("submit", "#middleBannerForm", function (e) {
            e.preventDefault();
            $(".errors").html("");
            formSubmit("middleBannerForm",$(this).attr("action"),"middleBannerModal",t)
        });

        $(document).on("click",".addNew",function(){
            $("#dataId").val('');
            $(".modaltitle").html("Create banner");
