...
<div class="content-header row">
    ...
    <div class="content-header-right text-md-end col-md-3 col-12 d-md-block d-none">
        <div class="mb-1 breadcrumb-right">
            <button type="button" class="btn btn-primary waves-effect waves-float waves-light waves-effect addNew" data-bs-toggle="modal" data-bs-target="#blogAuthor"><i data-feather="plus" class="fw-bold"></i> Add New</button>
        </div>
    </div>
</div>
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-datatable">
                    <table class="dt-responsive table" id="blogAuthorTable">
                        <thead>
                            <tr>
...
{{-- Modal start --}}
<div class="modal fade" id="blogAuthor" tabindex="-1" aria-labelledby="exampleModalCenterTitle" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form form-vertical" method="POST" action="{{route('blog-author.store')}}" id="blogTypeFrom">
                    @csrf
...
<script>
    $(document).ready(function () {
        ...
        var t = $('#blogAuthorTable').DataTable({
                    "scrollX":false,
                    "processing": true,
                    "serverSide": true,
                    "ajax": "",
        ...
        $("#blogAuthorTable").on('draw.dt', function(){
            let n = 0;
        ...
        $(document).on("submit", "#blogTypeFrom", function (e) {
            e.preventDefault();
            $(".errors").html("");
            formSubmit("blogTypeFrom",$(this).attr("action"),"blogAuthor",t)

        })

        $(document).on("click",".editData",function(e){

            $(".modaltitle").html("Update Blog author");
        ...
        $(document).on("click",".addNew",function(){
            ...
            $("#dataId").val('');
            $(".modaltitle").html("Create Blog author");
