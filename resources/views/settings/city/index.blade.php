...
<div class="content-header row">
    ...
    <div class="content-header-right text-md-end col-md-3 col-12 d-md-block d-none">
        <div class="mb-1 breadcrumb-right">
            <button type="button" class="btn btn-primary waves-effect waves-float waves-light waves-effect addNew" data-bs-toggle="modal" data-bs-target="#city"><i data-feather="plus" class="fw-bold"></i> Add New</button>
        </div>
    </div>
</div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-datatable">
                    <table class="dt-responsive table" id="cityTable">
                        <thead>
                            <tr>
...
{{-- Modal start --}}
<div class="modal fade" id="city" tabindex="-1" aria-labelledby="exampleModalCenterTitle" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title modaltitle" id="">Create city</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form class="form form-vertical" method="POST" action="{{route('city.store')}}" id="cityForm">
                    @csrf
...
<script>
    $(document).ready(function () {
        ...
        $(document).on("submit", "#cityForm", function (e) {
            e.preventDefault();
            $(".errors").html("");
            formSubmit("cityForm",$(this).attr("action"),"city",t)

        })

        $(document).on("click",".editData",function(e){

            $(".modaltitle").html("Update city");
