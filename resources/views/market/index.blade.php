...
<div class="content-header row">
    ...
    <div class="content-header-right text-md-end col-md-3 col-12 d-md-block d-none">
        <div class="mb-1 breadcrumb-right">
            <button type="button" class="btn btn-primary waves-effect waves-float waves-light waves-effect addNew" data-bs-toggle="modal" data-bs-target="#Market"><i data-feather="plus" class="fw-bold"></i> Add New</button>
        </div>
    </div>
</div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-datatable">
                    <table class="dt-responsive table" id="MarketTable">
                        <thead>
                            <tr>
...
{{-- Modal start --}}
<div class="modal fade" id="Market" tabindex="-1" aria-labelledby="exampleModalCenterTitle" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title modaltitle" id="">Create Market</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form class="form form-vertical" method="POST" action="{{route('market.store')}}" id="MarketForm">
                    @csrf
...
<script>
    $(document).ready(function () {
        ...
        $("#MarketTable").on('draw.dt', function(){
            let n = 0;
        ...
        $(document).on("submit", "#MarketForm", function (e) {
            e.preventDefault();
            $(".errors").html("");
            formSubmit("MarketForm",$(this).attr("action"),"Market",t)

        })

        $(document).on("click",".editData",function(e){

            $(".modaltitle").html("Update Market");
